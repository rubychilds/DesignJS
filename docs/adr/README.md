...
| [0009](./0009-design-tokens-architecture.md) | Design tokens — data model (DTCG), modes, CSS emission (Tailwind v4 `@theme`), agent surface | Phase 1 Accepted (2026-05-04); Phases 2 + 3 Proposed | Phase 1 — `67499c8` (DTCG store + migration + adapter), `563a906` (OKLCH-canonical color + colorSpace), `dcd055e` (Tailwind `@theme` dual-emit + collision detection), `7742953` (DTCG file import/export), `2055408` (post-Phase-1 fix: drop hyphen-as-separator inference in `cssVariableToPath`). See [Addendum](./0009-design-tokens-architecture.md#addendum-2026-05-04--phase-1-implementation-status). Phases 2+3 (modes, aliases, new MCP, kit cascade, full UX surfaces) remain Proposed per §10. |
...
| [0012](./0012-capture-fidelity-evolution.md) | Capture fidelity evolution — hybrid screenshot backplate + CDP pivot + three-tool split + author/computed hybrid | §1 Accepted (2026-04-24); §§2–4 Proposed | §1 — `f6ae37f` (hybrid backplate stitcher + relay + class-hoisted styling), `d4dcf43` (dedicated "Source screenshot backplate" opacity row in Appearance). See [Addendum](./0012-capture-fidelity-evolution.md#addendum-2026-04-24--1-implementation-status). §§2–4 remain Proposed; SingleFile price-check resolved 2026-05-04 (build in-house, see [Addendum 2026-05-04](./0012-capture-fidelity-evolution.md#addendum-2026-05-04--open-q-5-resolved-build-dont-buy)) — remaining gates are CDP pivot design + `debugger` permission. |
